// Package server wires up the HTTP server for dashboard-api.
package server
...
import (
        ...
        "github.com/vto/dashboard-api/internal/handler"
)
...
func (s *Server) Start(ctx context.Context) error {
        ...
        go func() {
                s.logger.Info().Str("addr", srv.Addr).Str("version", Version).Msg("dashboard-api starting")
