// Package server wires up the HTTP server for webhook-service.
package server
...
import (
        ...
        "github.com/vto/webhook-service/internal/handler"
)
...
func (s *Server) Start(ctx context.Context) error {
        ...
        go func() {
                s.logger.Info().Str("addr", srv.Addr).Str("version", Version).Msg("webhook-service starting")
