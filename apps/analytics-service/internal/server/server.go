// Package server wires up the HTTP server for analytics-service.
package server
...
import (
        ...
        "github.com/vto/analytics-service/internal/config"
        "github.com/vto/analytics-service/internal/handler"
)
...
func (s *Server) Start(ctx context.Context) error {
        ...
        go func() {
                s.logger.Info().Str("addr", srv.Addr).Str("version", Version).Msg("analytics-service starting")
