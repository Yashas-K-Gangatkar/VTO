// Package server wires up the HTTP server for inference-gateway.
package server
...
import (
        ...
        "github.com/vto/inference-gateway/internal/handler"
)
...
func (s *Server) Start(ctx context.Context) error {
        ...
        go func() {
                s.logger.Info().Str("addr", srv.Addr).Str("version", Version).Msg("inference-gateway starting")
