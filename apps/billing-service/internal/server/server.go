// Package server wires up the HTTP server for billing-service.
package server
...
import (
        ...
        "github.com/vto/billing-service/internal/handler"
)
...
func (s *Server) Start(ctx context.Context) error {
        ...
        go func() {
                s.logger.Info().Str("addr", srv.Addr).Str("version", Version).Msg("billing-service starting")
